...
public class testPerson {
    public void insertPerson() throws Exception {
        Person[] x = new Person[31];
         ...
         x[21] = new Person("Nick Vujicic", LocalDate.of(1982 , 10, 4 ), "Nicholas James \"Nick\" Vujicic (phát âm \"VOO-yee-cheech\", tiếng Serbia: Николас Џејмс Вујичић, Nikolas Džejms Vujičić, sinh ngày 4 tháng 12 năm 1982) là một người truyền bá Phúc Âm và diễn giả truyền cảm hứng người Úc gốc Serbia, khi được sinh ra đã không có tứ chi mà chỉ có 1 bàn chân và 2 ngón chân nhỏ", JobOfPerson.MOTIVATIONAL_SPEAKER);
