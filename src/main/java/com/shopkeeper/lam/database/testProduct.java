...
public class testProduct {
    public void insert() throws Exception {
        ...
        Product f1 = new Product(musics.get(0), ProductState.IMPORTING, null, null, 0, 0,
                "xnxx", "A18");
        Product f2 = new Product(musics.get(0), ProductState.ORDERED, null, null, 0, 0,
                "vlyy", "B3");
        Product f3 = new Product(films.get(0), ProductState.READY, null, null, 0, 0,
                "bacxyz", "C2");
        Product f4 = new Product(films.get(0), ProductState.RETURNED, null, null, 0, 0,
                "genksx", "D4");
        Product f5 = new Product(books.get(0), ProductState.SOLD, null, null, 0, 0,
                "hello", "E6");
