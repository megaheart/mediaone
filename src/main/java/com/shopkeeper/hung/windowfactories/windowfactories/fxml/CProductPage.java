...
import com.shopkeeper.hung.windowfactories.fxml.AddProductPage;
import com.shopkeeper.hung.windowfactories.fxml.Controller;
import com.shopkeeper.hung.windowfactories.fxml.ProductBriefInfoPage;
import com.shopkeeper.hung.windowfactories.fxml.ProductDetailPage;
...
public class CProductPage extends com.shopkeeper.hung.windowfactories.fxml.Controller implements Initializable {
    @FXML
    AnchorPane ancestor;
    @FXML
...
//            showedProducts.addAll(tempProduct); // add theo mode
    ...
    private void initItem(ProductInfo productInfo, int index){
        try{
            ...
            loader.load();
            com.shopkeeper.hung.windowfactories.fxml.ProductBriefInfoPage controller = loader.getController();
    ...
    public void setInfo(ProductInfo productInfo, com.shopkeeper.hung.windowfactories.fxml.ProductBriefInfoPage briefInfoPage){
