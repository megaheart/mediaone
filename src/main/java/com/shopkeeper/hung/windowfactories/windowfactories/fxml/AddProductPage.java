    ...
    public void setDoneButton() throws Exception {
        ...
        switch(temp){
            case "book"->{
                ...
                com.shopkeeper.hung.windowfactories.fxml.ProductPage parent =(com.shopkeeper.hung.windowfactories.fxml.ProductPage) this.getParent();
                parent.reload();
            ...
            case "music"->{
                ...
                res.setNumberOfProduct(productInfo.getNumberOfProduct());
                ProductInfoManager.getManager().add(res);
                com.shopkeeper.hung.windowfactories.fxml.ProductPage parent =(ProductPage) this.getParent();
                parent.reload();
                parent.getShowedProducts().add(res);
                parent.initShow(parent.getShowedProducts());
